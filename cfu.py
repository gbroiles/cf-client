...
def do_dns_update(cf, zone_name, zone_id, dns_name, ip_address, ip_address_type):
    ...
    for dns_record in dns_records:
        ...
        if ip_address == old_ip_address:
            syslog.syslog('UNCHANGED: %s %s' % (dns_name, ip_address))
            updated = True
            continue
        ...
        syslog.syslog('UPDATED: %s %s -> %s' % (dns_name, old_ip_address, ip_address))
        updated = True
    ...
    syslog.syslog('CREATED: %s %s' % (dns_name, ip_address))
